...
<body>
    ...
    <div class="container-fluid"><a class="navbar-brand p-0 px-2" href="index.php"><span class="nava">A</span><span
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav  mb-2 mb-lg-0 ms-auto ">
          ...
          <li class="nav-item mx-xl-4 mx-3"><a class="nav-link" href="#">Contact Us</a></li>
  ...
  <div class="mx-lg-5 mx-3 d-flex justify-content-center mt-3">
    <img src="images/corp4.jpg" class=" img-thumbnail w-100" alt="...">
  </div>


  <div class="container text-center">
    <h2 class="heading my-4"><b>Council Room</b>
    </h2>
  </div>
  ...
  <div class="container mb-5">
    ...
    <p class="text-center diff">
      Council Room is a perfect choice for small-sized corporate meetings.It has abundant natural daylight. It has a built-in projector and screen and provides complimentary wifi.

    </p>

</div>
	
	<div class="text-center mb-3 mb-md-4"><h3>Facilities</h3></div>
	
	
	<div class="container rounded bg-fac mb-4 mb-md-5 shadows">
	<div class=" py-3 py-md-4 d-flex justify-content-center text-white flex-wrap ">
		<div class="mx-3 mx-lg-5 mx-4 text-center"><i class="bi bi-easel h1"></i><p>Drop down screen and projector</p></div>
		<div class="mx-3 mx-lg-5 mx-4 text-center"><i class="bi bi-wind h1"></i><p>Air Conditioning</p></div>
		
		<div class="mx-3 mx-lg-5 mx-4 text-center"><i class="bi bi-wifi h1"></i><p>Complimentary Wi-Fi</p></div>
		<div class="mx-3 mx-lg-5 mx-4 text-center"><i class="bi bi-sun h1"></i><p>Natural daylight</p></div>
	</div>
	</div>
	
	<div class="container text-center">
		  <h5 class="">Capacity: <b>110</b></h5>
		  <h5 class="">Rate: <b>11000 Rs</b></h5>
	</div>
	
	<div class="text-center mt-5 mb-md-4 mb-3">
  <a class=" btn rounded-pill btn-warning px-md-4 bkaudi " href="BookAuditorium.php">Book Council Room</a>
</div>
