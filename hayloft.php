...
<body>
  ...
  <div class="mx-lg-5 mx-3 d-flex justify-content-center mt-3">
    <img src="images/corp2.jpg" class=" img-thumbnail w-100" alt="...">
  </div>


  <div class="container text-center">
    <h2 class="heading my-4"><b>Hayloft Gallery</b>
    </h2>
  </div>
  ...
  <div class="container mb-5">
    ...
    <p class="text-center diff">
      Located on the mezzanine level within Auditoria, Hayloft Gallery is a perfect plenary spacious room for medium sized meetings. The venue is abundant with plenty of natural daylight and has access to free wifi.
	...
	<div class=" py-3 d-flex justify-content-center text-white flex-wrap ">
		<div class="mx-3 mx-md-5 text-center"><i class="bi bi-easel h1"></i><p>Drop down screen and projector</p></div>
		<div class="mx-3 mx-md-5 text-center"><i class="bi bi-wind h1"></i><p>Air Conditioning</p></div>
		<div class="mx-3 mx-lg-5 mx-4 text-center"><i class="bi bi-tree h1"></i><p>Private Garden</p></div>
	...
	<div class="container text-center">
		  <h5 class="">Capacity: <b>180</b></h5>
		  <h5 class="">Rate: <b>16000 Rs</b></h5>
	</div>
	
	<div class="text-center mt-5 mb-md-4 mb-3">
  <a class=" btn rounded-pill btn-warning px-md-5 bkaudi " href="BookAuditorium.php">Book Hayloft Gallery</a>
</div>
