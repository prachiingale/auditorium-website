...
<head>
  ...
  <link rel="stylesheet" href=css/corporatemain.css> <link
...
<body>
  ...
  <div class="container text-center">
    <h2 class="heading my-4">Corporate Events</h2>
  </div>

  <div class="container mb-5">
    
      <p class="text-center diff">
        Whether you are looking to run a conference, corporate meeting, a training day, or a bespoke event in London,
        our versatile venue spaces can accommodate events of up to 210 people for a wide range of occasions.
        We have spacious rooms,adequate lighting and wide variety of technical equipments, including A/V and electrical.
        Technical assistance is provided at all our events.
      </p>
    
  </div>


  <div class="row row-cols-1 row-cols-md-2 g-4 g-xl-5 mx-2 mx-sm-5 mx-md-4 mx-lg-5 mb-5">
    <div class="col px-xxl-5">
      <a href="farmhouse.php">
        <div class="card">
          <img src="images/corp1-small.jpg" class="card-img-top" alt="...">
          <div class="card-body blue-bkg d-flex d-row justify-content-around">
            <h5 class="card-title text-center">Farmhouse Boardroom</h5>
            <i class="bi bi-arrow-right h5 d-none" id="arrow"></i>
          </div>
        </div>
      </a>
    </div>
    <div class="col px-xxl-5">
      <a href="hayloft.php">
        <div class="card">
          <img src="images/corp2-small.jpg" class="card-img-top" alt="...">
          <div class="card-body blue-bkg d-flex d-row justify-content-around">
            <h5 class="card-title text-center">Hayloft Gallery</h5>
            <i class="bi bi-arrow-right h5 d-none" id="arrow"></i>
          </div>
        </div>
      </a>
    ...
    <div class="col px-xxl-5">
      <a href="council.php">
        <div class="card">
          <img src="images/corp4.jpg" class="card-img-top" alt="...">
          <div class="card-body blue-bkg d-flex d-row justify-content-around">
            <h5 class="card-title text-center">Council Room</h5>
            <i class="bi bi-arrow-right h5 d-none" id="arrow"></i>
          </div>
        </div>
      </a>
    ...
    <div class="col px-xxl-5">
      <a href="main.php">
        <div class="card">
          <img src="images/corp3-small.jpg" class="card-img-top" alt="...">
          <div class="card-body blue-bkg d-flex d-row justify-content-around">
