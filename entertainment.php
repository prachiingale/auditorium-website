...
<head>
  ...
  <link rel="stylesheet" href=css/entertainment.css> <link
...
<nav class="navbar navbar-expand-lg navbar-dark purple">
    <div class="container-fluid"><a class="navbar-brand p-0 px-2" href="index.php"><span class="nava">A</span><span class="navrest">uditoria</span></a><button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav  mb-2 mb-lg-0 ms-auto ">
          <li class="nav-item mx-xl-4 mx-3"><a class="nav-link " aria-current="page" href="index.php">Home</a></li>
          <li class="nav-item dropdown mx-xl-4 mx-3 "><a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
            ...
            <ul class=" purple-dropdown dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item text-light" href="wedding.php">Events</a></li>
              <li>
  ...
  <div id="carouselExampleIndicators" class="carousel slide carousel-fade mx-md-5 mt-3 mx-2" data-bs-ride="carousel ">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active"><img src="images/social3.jpg" class="d-block w-100 img-thumbnail " alt="..."><div class="carousel-caption d-none d-sm-block text-white">
        <h4>Events At Auditoria</h5></div>
      </div>
      <div class="carousel-item"><img src="images/social2.jpg" class="d-block w-100  img-thumbnail" alt="..."><div class="carousel-caption d-none d-sm-block text-white">
        <h4>Events At Auditoria</h5></div></div>
      <div class="carousel-item"><img src="images/social1.jpg" class="d-block w-100  img-thumbnail" alt="..."><div class="carousel-caption d-none d-sm-block text-white">
        <h4>Events At Auditoria</h5></div></div>
        <div class="carousel-item"><img src="images/social5.jpg" class="d-block w-100  img-thumbnail" alt="..."><div class="carousel-caption d-none d-sm-block text-white">
        <h4>Events At Auditoria</h5></div></div>
    </div>
  ...
  <div class="container text-center">
    <h2 class="heading my-4">Swindon Hall</h2>
  </div>

  <div class="container pink-bga my-2 d-flex flex-column justify-content-center align-items-center">
  <p class=" text-center">
  The Swidon Hall offers an space for plays and performances while the impressive lighting and sound capabilities that offer enormous creative potential for any event.
  The lighting and the sound system can be changed as per your requirements.
  </p>
<p class=" text-center"><strong>Capacity: 280</strong></p>
<p class=" text-center"><strong>Rate: 30000 Rs</strong></p>
...
<div class="accordion " id="accordionPanelsStayOpenExample">
  ...
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div class="accordion-body">
        <p>Wall-Mounted Sound System</p>
        <p>Changeable Coloured Lighting</p>
        <p>House Lighting Rig</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div class="accordion-body">
        <p>Well-Experienced Event Manager</p>
        <p>On-site Technician</p>
...
<div class="container text-center my-5">
  <h3 class=" my-4">Customer Review</h3>
  <div class="bg p-3 mx-sm-3 mx-md-4 mx-lg-5 mb-3 rounded">
  <p class="h5 review-font">
  We had our band-Melodies performance at Auditoria in March 2019.
  The Event Planners were absolutely fantastic.
  The on-site technicians did solve a couple of our problems.
  Lighting was really great. 
  The service, and the inhouse staff were excellent.
  We would thoroughly recommend it to anyone who are looking for a place to host mesmerising events!
  </p>
  <p>~The Melodies</p>
  </div>
</div>
...
<div class="text-center mt-5 mb-md-5 mb-3">
  <a class=" btn rounded-pill book" href="BookAuditorium.php">Book Swindon Hall</a>
</div>
  <br>
  <br>
